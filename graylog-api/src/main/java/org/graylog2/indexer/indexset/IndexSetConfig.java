...
public abstract class IndexSetConfig implements Comparable<IndexSetConfig> {
    ...
    public static IndexSetConfig create(@Id @ObjectId @JsonProperty("_id") @Nullable String id,
        ...
        return builder()
                ...
                .indexAnalyzer(Strings.isNullOrEmpty(indexAnalyzer) ? "standard" : indexAnalyzer)
                .indexTemplateName(Strings.isNullOrEmpty(indexTemplateName) ? indexPrefix + "-template" : indexTemplateName)
